...
<h1>تعديل مواعيد الدروس بالمركز <i class="fa fa-clock-o"></i></h1>
            ...
            <tr>
              ...
              <div class="input-group input">
                <select  name="type" width="300" style="width: 100%">
                 ...
                 <tr>
                <td>اسم المدرس</td>
                <td><div class="input-group input"> <select  name="type" width="300" style="width: 100%"><!--اليوم-->
...
<option value="7">جمعة</option>
            ...
            <div>
                  <center>
                 <input type="submit"  name="submit" value="تعديل" class="btn btn-success" /> 
                  </center>
            </div>
     </form>
      </center>
